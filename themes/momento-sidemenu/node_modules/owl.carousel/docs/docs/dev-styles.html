...
<html lang="en">
  <head>
    ...
    <title>
      Sass Styles | Owl Carousel | 0.0.1
    </title>
      ...
      <div class="row">
        ...
        <div class="small-12 medium-9 large-9 columns">
          <article class="docs-content">
            ...
            <p>Check this
              <a href="http://benfrain.com/lightning-fast-sass-compiling-with-libsass-node-sass-and-grunt-sass/">tutorial</a>  to learn how to use Sass and libsass in Grunt environment.</p>
            <h3 id="scss-files-included">SCSS Files included</h3>
            <p>Source files can be found on
              <a href="https://github.com/smashingboxes/OwlCarousel2">Github Project</a> 
            </p>
            <pre><code>src/
└── scss/
    ├── _mixins.scss
    ...
    └── owl.theme.green.scss</code></pre>
            ...
            <p>Scss structure for theme. Use owl.carousel.defautl.scss to change variables and generate new styles.</p>
